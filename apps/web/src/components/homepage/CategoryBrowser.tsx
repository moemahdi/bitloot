...
const CATEGORY_GROUPS: CategoryGroup[] = [
    {
        ...
        color: 'cyan',
        categories: [
            { id: 'action', label: 'Action', icon: Swords, href: '/catalog?genre=action' },
            { id: 'fps', label: 'FPS', icon: Crosshair, href: '/catalog?genre=fps' },
            { id: 'rpg', label: 'RPG', icon: Shield, href: '/catalog?genre=rpg' },
            { id: 'adventure', label: 'Adventure', icon: Compass, href: '/catalog?genre=adventure' },
            { id: 'open-world', label: 'Open World', icon: Globe, href: '/catalog?genre=open-world' },
            { id: 'strategy', label: 'Strategy', icon: Brain, href: '/catalog?genre=strategy' },
            { id: 'racing', label: 'Racing', icon: Gauge, href: '/catalog?genre=racing' },
            { id: 'horror', label: 'Horror', icon: Skull, href: '/catalog?genre=horror' },
            { id: 'sports', label: 'Sports', icon: Trophy, href: '/catalog?genre=sports' },
            { id: 'survival', label: 'Survival', icon: Tent, href: '/catalog?genre=survival' },
            { id: 'mmo', label: 'MMO', icon: Users, href: '/catalog?genre=mmo' },
            { id: 'indie', label: 'Indie', icon: Palette, href: '/catalog?genre=indie' },
        ],
    },
    {
        id: 'platforms',
        ...
        color: 'purple',
        categories: [
            { id: 'steam', label: 'Steam', icon: Play, href: '/catalog?platform=steam' },
            { id: 'playstation', label: 'PlayStation', icon: Gamepad2, href: '/catalog?platform=playstation' },
            { id: 'xbox', label: 'Xbox', icon: Gamepad2, href: '/catalog?platform=xbox' },
            { id: 'nintendo', label: 'Nintendo', icon: Gamepad2, href: '/catalog?platform=nintendo' },
            { id: 'epic-games', label: 'Epic Games', icon: Play, href: '/catalog?platform=epic' },
            { id: 'pc', label: 'PC (Other)', icon: Laptop, href: '/catalog?platform=pc' },
        ],
    },
    {
        id: 'software',
